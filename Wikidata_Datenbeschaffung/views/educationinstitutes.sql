...
insert into `educationinstitutes_mview`
	 select distinct `educationinstitutes_label`.item_id as id, 
        ...
        if(`educationinstitutes_claim8`.value like "Q0%" or `educationinstitutes_claim8`.value like "Q1%" or `educationinstitutes_claim8`.value like "Q2%" or `educationinstitutes_claim8`.value like "Q3%" or `educationinstitutes_claim8`.value like "Q4%" or `educationinstitutes_claim8`.value like "Q5%" or `educationinstitutes_claim8`.value like "Q6%" or `educationinstitutes_claim8`.value like "Q7%" or `educationinstitutes_claim8`.value like "Q8%" or `educationinstitutes_claim8`.value like "Q9%", `cities_label`.label, educationinstitutes_claim8.value) as city,
    ...
    from `educationinstitutes_label` -- vlt erstes left löschen
		...
		Left JOIN `cities_label`												ON `educationinstitutes_claim8`.value = `cities_label`.item_id 					OR `educationinstitutes_claim8`.value = `cities_label`.label						AND `cities_label`.language = `educationinstitutes_label`.language -- Cities Tabelle aus Wikidata mit Städten aus edu_claim vergleichen
