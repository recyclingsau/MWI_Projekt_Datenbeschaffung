...
Insert into educationinstitutes_mview
    ...
    From educationinstitutes_label -- vlt erstes left löschen
        ...
        Left JOIN cities_label.label										ON educationinstitutes_claim8.value = cities_label.item_id 					AND cities_label.language = educationinstitutes_label.language -- Cities Tabelle aus Wikidata mit Städten aus edu_claim vergleichen
