CREATE OR REPLACE View persons_view
	as Select persons_label.label as Name, jobs_label.label as jobs_title, persons_link.url as wikipedia_hyperlink, persons_label.language as language, persons_label.item_id as person_ID, jobs_label.item_id as job_ID
		From persons_label
